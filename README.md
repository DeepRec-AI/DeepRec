...
```
$ bazel build --config=mkl_threadpool --copt=-march=skylake-avx512 //tensorflow/tools/pip_package:build_pip_package
```
Compile for CPU optimization and ABI=0
```
$ bazel build --cxxopt="-D_GLIBCXX_USE_CXX11_ABI=0" --host_cxxopt="-D_GLIBCXX_USE_CXX11_ABI=0" --config=mkl_threadpool --copt=-march=skylake-avx512 //tensorflow/tools/pip_package:build_pip_package
```
### **Create whl package** 
```
