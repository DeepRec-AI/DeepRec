...
#define REGISTER_CONCATCAST(type)                        \
REGISTER_KERNEL_BUILDER(Name("_FusedConcatCast")         \
                              .Device(DEVICE_CPU)        \
                              .TypeConstraint<type>("T") \
                              .HostMemory("axis"),       \
                          FusedConcatCastOp<type>)

TF_CALL_POD_STRING_TYPES(REGISTER_CONCATCAST);
REGISTER_CONCATCAST(quint8);
REGISTER_CONCATCAST(qint8);
REGISTER_CONCATCAST(quint16);
REGISTER_CONCATCAST(qint16);
REGISTER_CONCATCAST(qint32);
REGISTER_CONCATCAST(uint32);
REGISTER_CONCATCAST(uint64);
