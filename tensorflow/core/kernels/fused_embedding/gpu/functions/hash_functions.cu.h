#ifndef TENSORFLOW_CORE_KERNELS_FUSED_EMBEDDING_GPU_FUNCTIONS_HASH_FUNCTIONS_CU_H_
#define TENSORFLOW_CORE_KERNELS_FUSED_EMBEDDING_GPU_FUNCTIONS_HASH_FUNCTIONS_CU_H_
...
struct Fix_Hash {
  ...
  __forceinline__ __host__ __device__ static index_type hash(
      const key_type& key) {
    return result;
  }
};
...
struct Mod_Hash {
  __forceinline__ __host__ __device__ static result_type hash(
      const key_type& key) {
