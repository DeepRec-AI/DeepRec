...
class OpKernelContext {
 public:
  ...
  struct Params {
    ...
    // The step id which is generated by master session every round
    ...
    bool run_cost_model_schedule = false;
  ...
  bool is_input_dead(int idx) const {
    return params_->is_input_dead_details[idx];
  }
