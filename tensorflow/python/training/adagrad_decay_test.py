...
class AdagradDecayOptimizerTest(test.TestCase):
    ...
    for dtype in [dtypes.half, dtypes.float32, dtypes.float64]:
      for global_step_dtype in [dtypes.int32, dtypes.int64]:
        ...
        with self.test_session():
          ...
          ada_decay_opt = adagrad_decay.AdagradDecayOptimizer(
    ...
    for dtype in [dtypes.half, dtypes.float32, dtypes.float64]:
      ...
      with self.test_session():
        ...
        grad_aggregated = ops.IndexedSlices(
            ...
            constant_op.constant([1]),
            constant_op.constant([2, 1]))
        opt1 = adagrad_decay.AdagradDecayOptimizer(3.0, global_step1, accumulator_decay_step=2)
        opt2 = adagrad_decay.AdagradDecayOptimizer(3.0, global_step2, accumulator_decay_step=2)
