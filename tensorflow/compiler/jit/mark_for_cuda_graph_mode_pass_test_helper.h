...
#ifndef TENSORFLOW_COMPILER_JIT_MARK_FOR_CUDA_GRAPH_MODE_PASS_TEST_HELPER_H_
#define TENSORFLOW_COMPILER_JIT_MARK_FOR_CUDA_GRAPH_MODE_PASS_TEST_HELPER_H_

#include "tensorflow/compiler/jit/mark_for_cuda_graph_mode_pass.h"

namespace tensorflow {
class MarkForCudaGraphModePassTestHelper {
 public:
  struct Options {
  ...
  // registration and  _CgmodeCompile attributes.
...
#endif  // TENSORFLOW_COMPILER_JIT_MARK_FOR_CUDA_GRAPH_MODE_PASS_TEST_HELPER_H_
