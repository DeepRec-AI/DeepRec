...
public:
    ...
    size_t get_size_in_bytes() override {
        return tensor2_.get_size_in_bytes();
    }
    size_t get_num_elements() override {
        return tensor2_.get_num_elements();
    }

    bool allocated() const override {
        return tensor2_.allocated();
    }

protected:
    void* get_ptr() override {
        return tensor2_.get_ptr();
    } 

private:
    Tensor2Wrapper(HugeCTR::Tensor2<T>& tensor2)
    : tensor2_(tensor2) {}
