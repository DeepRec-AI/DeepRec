...
static const char* model_config = "{ \
    ...
    \"savedmodel_dir\": \"/home/deeprec/DeepRec/modelzoo/features/EmbeddingVariable/WDL/savedmodels/1658806107/\" \
  } ";
...
::tensorflow::eas::ArrayProto get_proto_cc(void* char_input, int dim,::tensorflow::eas::ArrayDataType type){
  ...
  switch(input.dtype()){
    ...
    case 7:
      ...
      break;
    case 9:
      input.add_int64_val(*((int*)char_input));
      break;
  }
...
int main(int argc, char** argv) {
  ...
  for(int ii = 0; ii < rows; ii++ ){
        ...
        for(int jj = 0; jj < 39; jj++){
          if( jj >= 0 && jj <= 8 ) inputs.I1_9[jj] = (float)(atof(all_elems[start_idx + jj]));
          else if( jj == 9) inputs.I10 = (int)atoi(all_elems[start_idx+9]);
          else if( jj >= 10 && jj <= 12) inputs.I11_13[jj-10] = (float)(atof(all_elems[start_idx + jj]));
        ...
        ::tensorflow::eas::ArrayProto I2 =  get_proto_cc(&inputs.I1_9[1],1,dtype_f);
        ::tensorflow::eas::ArrayProto I3 =  get_proto_cc(&inputs.I1_9[2],1,dtype_f);
        ::tensorflow::eas::ArrayProto I4 =  get_proto_cc(&inputs.I1_9[3],1,dtype_f);
        ::tensorflow::eas::ArrayProto I5 =  get_proto_cc(&inputs.I1_9[4],1,dtype_f);
        ::tensorflow::eas::ArrayProto I6 =  get_proto_cc(&inputs.I1_9[5],1,dtype_f);
        ::tensorflow::eas::ArrayProto I7 =  get_proto_cc(&inputs.I1_9[6],1,dtype_f);
        ::tensorflow::eas::ArrayProto I8 =  get_proto_cc(&inputs.I1_9[7],1,dtype_f);
        ::tensorflow::eas::ArrayProto I9 =  get_proto_cc(&inputs.I1_9[8],1,dtype_f);
        ::tensorflow::eas::ArrayProto I10 = get_proto_cc(&inputs.I10,1,dtype_i);
        ::tensorflow::eas::ArrayProto I11 = get_proto_cc(&inputs.I11_13[0],1,dtype_f);
        ::tensorflow::eas::ArrayProto I12 = get_proto_cc(&inputs.I11_13[1],1,dtype_f);
        ::tensorflow::eas::ArrayProto I13 = get_proto_cc(&inputs.I11_13[2],1,dtype_f);
