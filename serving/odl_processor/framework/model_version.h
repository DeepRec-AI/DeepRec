#ifndef SERVING_ODL_PROCESSOR_FRAMEWORK_MODEL_VERSION_H
#define SERVING_ODL_PROCESSOR_FRAMEWORK_MODEL_VERSION_H
#include <string.h>
...
#endif // SERVING_ODL_PROCESSOR_FRAMEWORK_MODEL_VERSION_H
