...
#ifndef SERVING_ODL_PROCESSOR_FRAMEWORK_GRAPH_OPTIMIZER_H_
#define SERVING_ODL_PROCESSOR_FRAMEWORK_GRAPH_OPTIMIZER_H_
...
#endif // SERVING_ODL_PROCESSOR_FRAMEWORK_GRAPH_OPTIMIZER_H_
