...
#ifndef SERVING_ODL_PROCESSOR_FRAMEWORK_UTIL_UTILS_H_
#define SERVING_ODL_PROCESSOR_FRAMEWORK_UTIL_UTILS_H_
...
#endif // SERVING_ODL_PROCESSOR_FRAMEWORK_UTIL_UTILS_H_
