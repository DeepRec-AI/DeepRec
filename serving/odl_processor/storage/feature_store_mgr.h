...
#ifndef SERVING_ODL_PROCESSOR_STORAGE_FEATURE_STORE_MGR_H_
#define SERVING_ODL_PROCESSOR_STORAGE_FEATURE_STORE_MGR_H_
...
#endif  // SERVING_ODL_PROCESSOR_STORAGE_FEATURE_STORE_MGR_H_
